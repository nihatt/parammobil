...
List<Category> categories = [
  Category(
      ...
      const GoldenDetails()),
  Category("Döviz", "Anlık Kur Takibi", "https://i.bigpara.com/resize/650x365/i/55big/dolar_650_4.jpg",
      const ExchangeDetails()),
  Category("Kripto Paralar", "Kripto Para Bilgileri",
      "https://www.justetf.com/images/thumbnails/etf-investment-guide-theme-crypto.jpg", const CyrptoDetails()),
  Category(
      "Canlı Borsa",
      "Canlı Borsa Takibi",
